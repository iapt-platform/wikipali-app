...
public class LanguageCatalog
{
    ...
    static Dictionary<string, string> myanmar = new Dictionary<string, string>()
    {
        { "0", "\u1040"},
            {"1", "\u1041"},
    {"2", "\u1042"},
    ...
    {"1", "1"},
        ...
        ;
    static Dictionary<string, string> mon = new Dictionary<string, string>()
    {
        {"0", "\u1040"},
    {"1", "\u1041"},
        {"2", "\u1042"},
    ...
    static Dictionary<string, string> zawgyi = new Dictionary<string, string>()
    {
        {"0", "\u1040"},
    {"1", "\u1041"},
        {"2", "\u1042"},
    ...
    public LanguageCatalog(Language2 language)
    {
    ...
    private string translate(Language2 language, string str)
    {
        switch (language)
        {
            case Language2.MYANMAR:
                return myanmar[str];
            case Language2.ENGLISH:
                return english[str];
            case Language2.MON:
                return mon[str];
            case Language2.ZAWGYI:
                return zawgyi[str];
            default:
                return myanmar[str];
        }
